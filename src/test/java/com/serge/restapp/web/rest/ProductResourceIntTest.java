package com.serge.restapp.web.rest;

import com.serge.restapp.HipsterappApp;

import com.serge.restapp.domain.Product;
import com.serge.restapp.repository.ProductRepository;
import com.serge.restapp.web.rest.errors.ExceptionTranslator;
...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getCity()).isEqualTo(DEFAULT_CITY);
        assertThat(testProduct.getProvider()).isEqualTo(DEFAULT_PROVIDER);
        ...
        assertThat(testProduct.getDistance()).isEqualTo(DEFAULT_DISTANCE);
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getCity()).isEqualTo(UPDATED_CITY);
        assertThat(testProduct.getProvider()).isEqualTo(UPDATED_PROVIDER);
        ...
        assertThat(testProduct.getDistance()).isEqualTo(UPDATED_DISTANCE);
