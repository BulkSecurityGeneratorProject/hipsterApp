...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "picture":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "provider":"SAMPLE_TEXT", "price":"0", "rating":null, "stars":null, "description":"SAMPLE_TEXT", "distance":null, "active":null}""")).asJSON
            .check(status.is(201))
